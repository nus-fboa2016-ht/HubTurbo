...
public class ChangeAssigneeAction implements Action<TurboIssue> {
    ...
    private String oldAssigneeLoginName;
    private String newAssigneeLoginName;
    private Logic logic;

    public ChangeAssigneeAction(Logic logic, Optional<String> oldAssigneeLoginName, Optional<String> newAssigneeLoginName) {
